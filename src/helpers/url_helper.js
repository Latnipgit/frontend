...
//LOGIN
export const POST_FAKE_LOGIN = "https://bafana-backend.azurewebsites.net/api/admin/login";
export const POST_FAKE_JWT_LOGIN = "https://bafana-backend.azurewebsites.net/api/admin/login";
